...
### 10주차 (5/6, 5/11): LLM API 활용 멀티모달 내용분석
...
### 11주차 (5/13, ~~5/18~~): LLM + 검색: API, RSS 등 활용
...
### 14주차 (~~6/3~~, 6/8): LLM 에이전트 & LangGraph 워크플로우
...
- 특강 (6/17): 라인플러스 안정윤 PD
- **기말고사 (6/22)**: 컴퓨터 AI 활용 과제 수행(코드와 결과물을 이캠퍼스에 제출). 408호(학번 끝자리 짝수) 402호(학번 끝자리 홀수)        
- **프로젝트 기획안 제출 (6/23, ecampus > 과제및평가에 제출)**
